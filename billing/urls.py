...
urlpatterns = [
    ...
    path('top_up_details/<str:item_id>/', views.top_up_details, name='top_up_details'),
    path('top_up_details/<str:item_id>/refund/', views.top_up_refund, name='top_up_refund'),
    path('top_up_details_crypto/<str:item_id>/', views.top_up_details_crypto, name='crypto_top_up_details'),
    ...
    path('accounts/manual_refund/<item_id>/', views.admin.manual_refund, name='manual_refund'),
