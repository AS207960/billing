...
urlpatterns = [
    ...
    path('complete_top_up_sepa_direct_debit/<uuid:item_id>/', views.complete_top_up_sepa_direct_debit,
    ...
    path('complete_charge/<uuid:charge_id>/', views.complete_charge, name='complete_charge'),
    path('fail_charge/<uuid:charge_id>/', views.fail_charge, name='fail_charge'),
